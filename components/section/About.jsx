...
const About = ({ id, className }) => {
    return (
        <section id={ id } className={ `w-full mt-10 md:mt-0 px-6 md:px-8 flex flex-col items-center justify-start ${className}` }>
            <div className='flex flex-col md:flex-row items-center mb-16 justify-center max-w-screen-xl'>
                <div
                    data-aos="fade-right"
